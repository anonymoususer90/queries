...
#ifdef PANDORA
extern int FileRequest(struct io_uring* ring, File file, struct iovec *iovs, 
...
#ifdef PANDORA
extern int PandoraSimpleOpen(const char *fileName, int fileFlags);
extern int PandoraSimpleClose(int fd);
#endif /* PANDORA */
