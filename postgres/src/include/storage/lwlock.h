...
/* Default number of ebi sub buffer partitions */
#define NUM_EBI_SUB_PARTITIONS (1024)
#endif /* DIVA */

#ifdef PANDORA
#define NUM_PANDORA_RELATION_META_PARTITIONS (256)
#endif /* PANDORA */
...
/* 
 * This macro doesn't have any function.
 * We declare this just to solve compiler error.
 */
#define EBI_TREE_MAPPING_LWLOCK_OFFSET  0

#define EBI_SUB_MAPPING_LWLOCK_OFFSET   \
	(PLEAF_MAPPING_LWLOCK_OFFSET + NUM_PLEAF_PARTITIONS)

#define LOCK_MANAGER_LWLOCK_OFFSET		\
  (EBI_SUB_MAPPING_LWLOCK_OFFSET + NUM_EBI_SUB_PARTITIONS)
...
#ifdef PANDORA
#define PANDORA_RELATION_META_MAPPING_LWLOCK_OFFSET   \
	(LOCK_MANAGER_LWLOCK_OFFSET + NUM_LOCK_PARTITIONS)
#define PREDICATELOCK_MANAGER_LWLOCK_OFFSET \
	(PANDORA_RELATION_META_MAPPING_LWLOCK_OFFSET + NUM_PANDORA_RELATION_META_PARTITIONS)
#else /* PANDORA */
#define PREDICATELOCK_MANAGER_LWLOCK_OFFSET \
	(LOCK_MANAGER_LWLOCK_OFFSET + NUM_LOCK_PARTITIONS)
#endif /* !PANDORA */
