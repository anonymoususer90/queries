...
extern PGDLLIMPORT int NEbiReadBuffers;
...
#endif
#ifdef PANDORA
	B_PANDORA_PARTITION_LAUNCHER,
	B_PANDORA_PARTITION_WORKER,
	B_PANDORA_BG_WRITER,
#endif
	B_ARCHIVER,
	B_LOGGER,
...
#endif
#ifdef PANDORA
#define AmPandoraBackgroundWriterProcess() \
			(MyAuxProcType == PandoraBgWriterProcess)
#endif
