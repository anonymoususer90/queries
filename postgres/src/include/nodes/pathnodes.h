...
#ifdef HAP_REDUCTION
	double		hapReductionTime; /* total time (ms) of hap query reduction */
#endif
} PlannerGlobal;
...
#ifdef HAP
	List	   *hap_propagate_paths; /* Filter propagate paths */
	List	   *hap_propagated_exprs; /* Filter propagate exprs */
	List	   *hap_propagated_joininfo_exprs; /* "Propagated" joininfo
												* expressions  */
	List	   *hap_propagating_joininfo_maps; /* List of
												* HapJoinInfoMap */
#endif /* HAP */

#ifdef HAP_REDUCTION
	Relids	   *attr_referenced; 	/* array indexed [min_attr .. max_attr] */
	AttrNums	primarykeyattrs; 	/* bitmapset of primary key columns */
	bool		is_redundant; 		/* is it redundant? */
	List		*substitution_info; 	/* List of HapSubstitutionInfo */
#endif /* HAP_REDUCTION */
} RelOptInfo;
...
#ifdef HAP
	bool		hap_info_has_propagated;
	bool		hap_info_is_hidden_attribute;
	bool		hap_info_do_not_propagate;
	Selectivity hap_hidden_attribute_selectivity;
#endif /* HAP */
} RestrictInfo;
