...
typedef struct TableScanDescData
{
	...
	struct ParallelTableScanDescData *rs_parallel;	/* parallel scan
													 * information */
#ifdef DIVA
	uint64 counter_in_heap;
	uint64 counter_in_ebi;
	uint64 counter_duplicates;
	bool siro;
	bool is_heapscan;
#ifdef PANDORA
	struct PrefetchDescData	*rs_prefetch;		/* prefetch information */
#endif /* PANDORA */
#endif /* DIVA */
...
#ifdef PANDORA
	PandoraFingerprint xs_fingerprint;

	int 		lastPartitionLevel; /* last partition level */
#endif /* PANDORA */
