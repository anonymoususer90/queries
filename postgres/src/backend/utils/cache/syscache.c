...
static const struct cachedesc cacheinfo[] = {
	...
	{HapHiddenAttributeDescRelationId,		/* HAPDESCCONFID */
		HapHiddenAttributeDescRelidConfrelidConfdescidIndexId,
		3,
		{
			Anum_pg_hap_hidden_attribute_desc_haprelid,
			Anum_pg_hap_hidden_attribute_desc_hapconfrelid,
			Anum_pg_hap_hidden_attribute_desc_hapconfdescid,
			0
		},
		32
	},
	{HapHiddenAttributeDescRelationId,		/* HAPDESCRELID */
		HapHiddenAttributeDescRelidDescidIndexId,
		2,
		{
			Anum_pg_hap_hidden_attribute_desc_haprelid,
			Anum_pg_hap_hidden_attribute_desc_hapdescid,
			0,
			0
		},
		32
	},
	{HapEncodedAttributeRelationId,			/* HAPENCODEDID */
		HapEncodedAttributeRelidAttrnumIndexId,
		2,
		{
			Anum_pg_hap_encoded_attribute_haprelid,
			Anum_pg_hap_encoded_attribute_hapattrnum,
			0,
			0
		},
		32
	},
	{HapPartitionMapRelationId,			/* HAPPARTMAP */
		HapPartitionMapRelIdIndexId,
		1,
		{
			Anum_pg_hap_partition_map_haprelid,
			0,
			0,
			0
		},
	...
	{HapRelationId,				/* HAPRELID */
		HapRelIdIndexId,
		1,
		{
			Anum_pg_hap_haprelid,
			0,
			0,
			0
		},
	...
	{PandoraRelationId,			/* PANDORARELID */
		PandoraRelIdIndexId,
		1,
		{
