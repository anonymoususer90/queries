...
typedef struct HeapScanDescData
{
	...
	struct timespec seqscan_start_time;
	int lockfree_measure_fd;
#endif
}			HeapScanDescData;
...
#ifdef PANDORA
/*
 * Descriptor for pandora partition scans.
 */
typedef struct PandoraScanDescData
{
...
typedef struct PandoraScanDescData *PandoraScanDesc;
#endif /* PANDORA */
...
#ifdef PANDORA
extern void PandoraFingerprintGetTuplePositionForIndexscan(
									PandoraRelationMeta *meta, 
									Relation relation, 
									PandoraFingerprint fingerprint,
									PandoraTuplePosition tuplePosition);

extern void PandoraFingerprintGetTuplePositionForUpdate(PandoraRelationMeta *meta, 
									Relation relation, 
									PandoraFingerprint fingerprint,
									PandoraTuplePosition tuplePosition);

extern bool pandora_search_version(PandoraTuplePosition tuplePosition, 
								   Relation relation, 
...
extern bool HeapTupleSetHintBitsForPartition(HeapTuple htup, Buffer buffer);
extern void PandoraFingerprintGetTuplePosition(PandoraRelationMeta *meta,
											   Relation relation, 
											   PandoraFingerprint fingerprint,
											   PandoraTuplePosition tuplePosition);
extern void pandora_insert(Relation relation, HeapTuple tup, CommandId cid,
						   int options, BulkInsertState bistate);
extern TableScanDesc pandora_beginscan(Relation relation, Snapshot snapshot,
										 int nkeys, ScanKey key,
										 ParallelTableScanDesc parallel_scan,
										 uint32 flags,
										 List *hap_partid_list);
extern void pandora_rescan(TableScanDesc sscan, ScanKey key, bool set_params,
						   bool allow_strat, bool allow_sync, bool allow_pagemode);
extern void pandora_endscan(TableScanDesc sscan);
extern void pandoragetpage(TableScanDesc sscan);
extern HeapTuple pandora_getnext(TableScanDesc sscan, ScanDirection direction);
extern bool pandora_getnextslot(TableScanDesc sscan, ScanDirection direction,
								TupleTableSlot *slot);
#endif /* PANDORA */
#endif							/* HEAPAM_H */
