...
( \
	...
	(a).partLvl = InvalidPandoraPartLevel, \
	(a).partNum = InvalidPandoraPartNumber, \
	(a).partGen = InvalidPandoraPartGenNo, \
	(a).blockNum = InvalidBlockNumber \
)

#define INIT_BUFFERTAG_EXTENDED(a,xx_rnode,xx_forkNum,xx_partLvl,xx_partNum,xx_partGen,xx_blockNum) \
( \
	(a).rnode = (xx_rnode), \
	(a).forkNum = (xx_forkNum), \
	(a).partLvl = (xx_partLvl), \
	(a).partNum = (xx_partNum), \
	(a).partGen = (xx_partGen), \
	(a).blockNum = (xx_blockNum) \
)

#define INIT_BUFFERTAG(a,xx_rnode,xx_forkNum,xx_blockNum) \
	(INIT_BUFFERTAG_EXTENDED(a,xx_rnode,xx_forkNum,InvalidPandoraPartLevel,InvalidPandoraPartNumber,InvalidPandoraPartGenNo,xx_blockNum))
...
#ifdef PANDORA
	pg_atomic_uint32 inserted_cnt; /* only for insert */
#endif /* PANDORA */
} BufferDesc;
...
#ifdef PANDORA
#define BufferDescriptorGetDualRef(bdesc) \
	((void*) (&(bdesc)->dual_ref))
#endif /* PANDORA */
...
#ifdef PANDORA
extern PGDLLIMPORT LWLockPadded *PandoraMempartLocks;
#endif /* PANDORA */
...
extern BufferDesc *StrategyGetBuffer(BufferAccessStrategy strategy,
									 uint32 *buf_state);
#ifdef PANDORA
extern BufferDesc *PandoraStrategyGetBuffer(uint32 *buf_state);
extern BufferDesc *PandoraStrategyGetVictimMempartitionBuffer(uint32 *buf_stat);
extern void PandoraStrategyFreeBuffer(BufferDesc *buf);
#endif /* PANDORA */
