...
#ifdef PANDORA
#include "postmaster/pandora_bgwriter.h"
#endif
...
static struct config_bool ConfigureNamesBool[] =
{
#if PANDORA
	{
		{"enable_prefetch", PGC_USERSET, CUSTOM_OPTIONS,
			gettext_noop("Enables the executor's use of prefetching seqscan."),
			NULL,
			GUC_EXPLAIN
		},
		&enable_prefetch,
...
#ifdef HAP
	{
		{"enable_hap_planner", PGC_USERSET, QUERY_TUNING_METHOD,
			gettext_noop("Enables HAP's planner."),
			NULL,
			GUC_EXPLAIN
		},
		&enable_hap_planner,
	...
	{
		{"enable_hap_selectivity", PGC_USERSET, QUERY_TUNING_METHOD,
			gettext_noop("Enables HAP's selectivity."),
			NULL,
			GUC_EXPLAIN
		},
		&enable_hap_selectivity,
		false,
		NULL, NULL, NULL
	},
#endif
#ifdef HAP_REDUCTION
	{
		{"enable_hap_reduction", PGC_USERSET, QUERY_TUNING_METHOD,
			gettext_noop("Enables query reduction with HAP."),
			NULL,
			GUC_EXPLAIN
		},
		&enable_hap_reduction,
		true,
		NULL, NULL, NULL
	},
#endif
...
static struct config_int ConfigureNamesInt[] =
{
...
#ifdef PANDORA
	{
		{"pandora_bgwriter_delay", PGC_SIGHUP, RESOURCES_BGWRITER,
			gettext_noop("Pandora background writer sleep time between rounds."),
			NULL,
			GUC_UNIT_MS
		},
		&PandoraBgWriterDelay,
		200, 10, 10000,
		NULL, NULL, NULL
	},
#endif
	...
	{
		{"mod_value", PGC_USERSET, CUSTOM_OPTIONS,
			gettext_noop("Determine timer rate"),
			NULL,
			GUC_UNIT_S
		},
		&mod_value,
